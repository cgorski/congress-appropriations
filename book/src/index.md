...
- **[Recipes & Demos](./tutorials/cookbook.md)** — Worked examples for account tracking, fiscal year comparisons, inflation adjustment, Python/pandas integration, and data export. Interactive visualizations included.
- **[Getting Started](./getting-started/installation.md)** — Install the tool and run your first query in under five minutes. Covers installation and first commands.

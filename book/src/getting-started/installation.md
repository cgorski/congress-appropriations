...
Cloning the repository gives you the full example data — three pre-extracted FY2024 appropriations bills with pre-computed embeddings, ready to query with no API keys.
...
If you see this table with three bills and 2,501 total provisions, everything is working. You're ready to start querying.

...
In the example data: **2,392 of 2,501 provisions (95.6%)** match at the exact tier. This is the strongest evidence that the provision was faithfully extracted from the correct location in the bill.
...
- **0** dollar amounts not found in source (across 2,501 provisions)
